...
export const messages = {
  ...
  pages: {
    ...
    protocolos:
      'Planeje e acompanhe protocolos de administração com calendário multi-fuso, análise temporal e estimativas farmacocinéticas.',
  ...
  library: {
    ...
    actionError: 'Não foi possível preparar esta ação. Revise os parâmetros e tente novamente.',
    ...
    profileRequiredForAction: 'É necessário um perfil farmacocinético para usar esta ação.',
  ...
  protocols: {
    title: 'Protocolos',
    subtitle: 'Planejamento e acompanhamento de protocolos com calendário multi-fuso e estimativas farmacocinéticas.',
    ...
    moveProtocol: 'Mover protocolo',
    confirmDeleteTitle: 'Excluir protocolo',
    confirmDeleteMessage: (name: string) =>
      `Tem certeza de que deseja excluir o protocolo "${name}"? Esta ação removerá o agendamento correspondente.`,
    cancel: 'Cancelar',
    confirmDelete: 'Excluir',
    save: 'Salvar alterações',
    create: 'Criar protocolo',
    formName: 'Nome do protocolo',
    formTotalDose: 'Dose total informada (mg)',
    formStartDate: 'Data inicial',
    formTime: 'Horário',
    formTimeZone: 'Fuso horário do protocolo',
    formRecurrenceType: 'Tipo de recorrência',
    recurrenceSingle: 'Dose única',
    recurrenceWeekly: 'Semanal recorrente',
    formWeekdays: 'Dias da semana',
    formWeeks: 'Duração (número de semanas)',
    componentsTitle: 'Componentes e proporções',
    addComponent: 'Adicionar componente',
    removeComponent: 'Remover componente',
    componentLabel: 'Nome do componente',
    componentProportion: 'Proporção',
    componentColor: 'Cor do componente',
    componentHalfLifeDays: 'Meia-vida (dias)',
    componentTmaxDays: 'Tmax (dias)',
    halfLifeHelper: 'Informe em dias.',
    tmaxHelper: 'Informe em dias. Use 0 para absorção imediata.',
    equivalenceHelper: (hours: string) => `Equivale a aproximadamente ${hours} h.`,
    undoAction: 'Desfazer',
    rescheduledNotice: (name: string) => `Protocolo "${name}" reagendado com sucesso.`,
    undoSuccessNotice: 'Reagendamento desfeito com sucesso.',
    undoError: 'Não foi possível desfazer o reagendamento.',
    saveSuccessNotice: 'Protocolo salvo com sucesso.',
    deleteSuccessNotice: 'Protocolo excluído com sucesso.',
    protocolsMaxReached: 'Limite de 200 protocolos atingido. Remova protocolos antes de cadastrar novos.',
    noProtocols: 'Nenhum protocolo cadastrado. Clique em "Novo protocolo" para começar.',
    noOccurrencesInWindow: 'Nenhuma administração agendada para o período visível.',
    chartModeLabel: 'Modo de exibição do gráfico:',
    chartCombined: 'Combinado (todas as séries)',
    chartIndividual: 'Individual (por protocolo)',
    rangeStart: 'Início da janela',
    rangeEnd: 'Fim da janela',
    selectProtocols: 'Protocolos exibidos:',
    daySheetTitle: (date: string) => `Administrações em ${date}`,
    daySheetClose: 'Fechar detalhes do dia',
    keyboardMoveInstructions:
      'Use as setas (←/→ dia, ↑/↓ semana) para mover. Pressione Enter para confirmar ou Escape para cancelar.',
    movingCardStatus: (name: string, date: string) => `Movendo ${name}. Nova data selecionada: ${date}.`,
    chipEstimatedTitle: (name: string, amount: string) => `≈ ${name}: ${amount} mg`,
    guidesLabel: 'Guias de administração',
    kineticChartAriaLabel: 'Gráfico farmacocinético de curvas temporais dos protocolos',
    noSeriesSelected: 'Selecione ao menos um protocolo para visualizar o gráfico.',
    quickMenuAria: (name: string) => `Ações para administração de ${name}`,
    calendarTimeZoneNotice: (tz: string) => `Fuso de exibição do calendário: ${tz}`,
    configNotLoaded: 'Configuração ainda não carregada.',
    saveError: 'Ocorreu um erro ao salvar as alterações do protocolo.',
    chartTableFallback: 'Resumo das curvas e picos estimados dos protocolos',
    seriesColumnHeader: 'Série (Protocolo / Componente)',
    peakColumnHeader: 'Pico estimado',
  },
} as const
